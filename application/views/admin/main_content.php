                ...
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php
                            ...
                            ?></span>
                        <a href="<?php echo base_url() ?>admin/employee/employees" class="small-box-footer"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div><!-- end Total Employee-->
                <!-- Total Award-->
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><?= lang('total_award') ?></span>
                        <span class="info-box-number"><?php
                ...
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number"><?php
                            ...
                            ?></span>
                        <a href="<?php echo base_url() ?>admin/expense/expenses" class="small-box-footer"><?= lang('more_info') ?> <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="chart-responsive" >
                                    <!--Sales Chart Canvas -->
                                    <div style="width:500px; heigth:800px;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="<?php echo base_url() ?>admin/mailbox/read_inbox_mail/<?php echo $v_inbox_msg->inbox_id ?>"><?php
                                                                if ($v_inbox_msg->view_status == 1) {
                                                                    echo '<span style="color:#000">' . $v_inbox_msg->from . '</span>';
                                                                } else {
                                                                    echo '<b style="color:#000;font-size:14px;">' . $v_inbox_msg->from . '</b>';
                                                                }
                                                                ?></a></td>
...
?>
    ...
    var buyers = document.getElementById('buyers').getContext('2d');
            // draw line chart
            // buyers.canvas.width = 300;
            // buyers.canvas.height = 100;
