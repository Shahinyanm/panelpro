...
<div class="row">
    <div class="col-sm-3">
        <div class="box box-primary" data-collapsed="0">
            ...
            <form id="form_validation" action="<?php echo base_url() ?>admin/task/update_status/<?php if (!empty($task_details->task_id)) echo $task_details->task_id; ?>" method="post">
                <div class="box-body">
                    ...
                    <div class="form-group">                    
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="int"  readonly name="task_progress"
                ...
                <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="task_comments" style="position: relative;">
                    <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">                        
                        <div class="box-body chat" id="chat-box">
                            ...
                            <form id="form_validation" action="<?php echo base_url() ?>admin/task/save_comments" method="post" class="form-horizontal">
