...
<html>
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            ...
            $msgMail = $this->session->userdata('msgMail');

            if (!empty($msg)){ echo "<div class=row'><div class='alert alert-success'>".$msg."</div></div>";}
            if (!empty($msgMail)){ echo "<div class=row'><div class='alert alert-success'>".$msgMail."</div></div>";}
            ...
            <div class="login-box-body">
                ...
                <form action="<?php echo base_url() ?>login" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            <a href="<?php echo base_url() .'register'?>"  class="btn btn-primary btn-block btn-flat">Sign up </a>
                        </div>
                    </div>
                </form>                             
            </div><!-- /.login-box-body -->
