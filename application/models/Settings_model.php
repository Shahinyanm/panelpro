...
class Settings_Model extends MY_Model {
    ...
    function translation_stats($files) {
        ...
        foreach ($languages as $lang) {
            ...
            foreach ($files as $file => $altpath) {
                ...
                $en = $this->lang->load('en','english', TRUE, TRUE);
    ...
    function save_translation($language, $file) {
        ...
        if ($language == 'english') {
            $file = 'english';
            $fullpath = "./system/language/english/" . $file . "_lang.php";
        } else {
            $fullpath = "./system/language/" . $language . "/" . $file . "_lang.php";
        }
        $this->lang->load('english.php', 'english', TRUE, TRUE);
        $eng = $this->lang->language;
        
        if ($language == 'english') {
            $trn = $eng;
        } else {
             $this->lang->load($file, $language, TRUE, TRUE);
             $trn =$this->lang->language;
        }
