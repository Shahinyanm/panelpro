                ...
                <div class="col-lg-12 well-user-profile">
                    <div class="row">                            
                        <div class="col-lg-2 col-sm-2">
                            <div class="fileinput-new thumbnail" style="width: 144px; height: 130px; margin-top: 14px; margin-left: 16px; background-color: #EBEBEB;">
                                <?php if ($employee_details->photo): ?>
                                    <img src="<?php echo base_url() . $employee_details->photo; ?>" style="width: 142px; height: 120px; border-radius: 3px;" >
                                <?php else: ?>
                ...
                <div class="row">
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">                                
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="form-control-static"><?php echo "$employee_details->middle_name"; ?></p>                                                                                          
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body form-horizontal">
                                <?php if (!empty($employee_details->holder_name)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('holder_name')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->holder_name"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <?php if (!empty($employee_details->type_of_account)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('type_of_account')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->type_of_account"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($employee_details->bank_address)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('bank_address')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->bank_address"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($employee_details->aba_check_routing_number)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('aba_check_routing_number')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->aba_check_routing_number"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($employee_details->ach_routing_transit_number)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('ach_routing_transit_number')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->ach_routing_transit_number"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($employee_details->wire_routing)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('wire_routing')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->wire_routing"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
                                <?php if (!empty($employee_details->bank_account_number)): ?>
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label" ><?= lang('bank_account_number')?>:</label>
                                        <div class="col-sm-8">
                                            <p class="form-control-static"><?php echo "$employee_details->bank_account_number"; ?></p>
                                        </div>
                                    </div>
                                <?php endif; ?>
