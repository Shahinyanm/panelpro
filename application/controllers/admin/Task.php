...
class Task extends Admin_Controller {
    ...
    public function all_task($id = NULL) {
        ...
        $data['employee_info'] = $this->task_model->get_by(array('status' => 1, 'employment_id'=>'employee','deleted' => 0), FALSE);
    ...
    public function all_task_contact($id = NULL) {
        ...
        $data['employee_info'] = $this->task_contact_model->get_by(array('status' => 1, 'employment_id'=>'employee','deleted' => 0), FALSE);
        //get all training information
