...
<div class="col-sm-12">
    ...
    <div class="row">
                    ...
                    <div class="form-group">                    
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="progress">
                                    <?php
                                    if ($task_details->task_contact_progress < 40) {
                                        $bar = 'progress-bar-danger';
                                    } else {
                                        $bar = 'progress-bar-success';
                                    }
                                    ?>
                                    <div class="progress-bar <?= $bar ?>" style="width:<?= $task_details->task_contact_progress; ?>%"><?= $task_details->task_contact_progress; ?>%</div>
                                </div>                            
                            </div>
        ...
        <div class="col-sm-9">
                        ...
                        <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">                         
                            <div class="box-body">
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <div class="col-sm-7">
                                        <?php if (!empty($task_details->web)): ?>

                                        <?php  if(!strpos($task_details->web,'https://')){

                                             echo anchor('https://'.$task_details->web, $task_details->web, 'title=' . $task_details->web . '');
                                         }else{
                                             echo anchor($task_details->web, $task_details->web, 'title="' . $task_details->web . '"');
                                            }?>
                                        <?php endif; ?>
            ...
            <div class="form-group col-sm-12" id="border-none">                   <label class="col-sm-3 control-label"><?= lang('assined_to') ?></label>
            <div class="col-sm-7">
                    ...
                    <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="task_comments" style="position: relative;">
                        <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">                        
                            <div class="box-body chat" id="chat-box">
                                ...
                                <form id="form_validation" action="<?php echo base_url() ?>employee/dashboard/save_contact_comments" method="post" class="form-horizontal">
                    ...
                    <div class="tab-pane <?= $active == 3 ? 'active' : '' ?>" id="task_attachments" style="position: relative;">
                        <div class="box" style="border: none; padding-top: 15px;" data-collapsed="0">                        
                            <div class="panel-body">
                                ...
                                <form action="<?= base_url() ?>employee/dashboard/save_task_contact_attachment/<?php
                            ...
                            <div class="box-body">
                                ...
                                <div class="tab-content no-padding">
                                    <div class="tab-pane <?= $active == 1 ? 'active' : '' ?>" id="team" style="position: relative; margin-top:10px;">
                                        <form  action="<?php echo base_url() ?>employee/dashboard/save_team_links/<?php if (!empty($task_details->task_contact_id)) {
                                            echo $task_details->task_contact_id;
                ...
                <div class="col-sm-12 link_box" >
                    ...
                    <div class="col-sm-11 sum" style="border:1px solid #EFEFEF;; padding-top: 15px;" >
                        ...
                        <?php  echo  '<div class="col-sm-12" style="padding:3px"><div class="col-sm-4" style="background:#83c583; border: none; padding-top: 5px;"> <span>' . lang('full_name') . '</span></div>'; ?>
                        ...
                        <div class="col-sm-1"> <a href ="<?= base_url() ?>employee/dashboard/delete_team_link/<?= $team->team_id ?>/<?= $task_details->task_contact_id?>" class="btn btn-danger btn-xs delete" style="margin:5px">  &nbsp;X </a></div>
                    ...
                    <?php if(!empty($team->linkidn)) {
                        ...
                        echo '<div class="col-sm-8 linkidn"> <input type="checkbox" style="display:none" name="linkidn_check" class="linkidn_check hid">  <input type="text" class="linkidn form-control" name="linkidn[]" placeholder="profile link" style="display:none"></div></div>';
                                            ...
                                            <?php else: ?>
                                                <div class="col-sm-11 links sum" style="border:1px solid #dff6e0; padding-top: 15px;" >
                                                    <div class="col-sm-12" style="padding:3px">
                                                        <div class="col-sm-4 " style="background:#83c583; border: none; padding-top: 5px;"> <span><?php echo  lang('full_name') ?></span></div>
                                    ...
                                    <div class="tab-pane <?= $active == 2 ? 'active' : '' ?>" id="advisors" style="position: relative; margin-top:10px;">
                                        <form  action="<?php echo base_url() ?>employee/dashboard/save_advisor_links/<?php if (!empty($task_details->task_contact_id)) {
                                            echo $task_details->task_contact_id;
                                        }?>" method="post" class="form-horizontal">
                                            <div class="col-sm-12 link_box" >
                                                <div class="col-sm-11" style="background:#83c583; border: none; padding-top: 5px;">
                                                ...
                                                <div class="col-sm-1"> <a href ="<?= base_url() ?>employee/dashboard/delete_advisor_link/<?= $advisor->advisor_id ?>/<?= $task_details->task_contact_id?>" class="btn btn-danger btn-xs delete" style="margin:5px">  &nbsp;X </a></div></div>
                                    ...
                                    <div class="tab-pane <?= $active == 3? 'active' : '' ?>" id="partners" style="position: relative; margin-top:10px;">
                                        <form  action="<?php echo base_url() ?>employee/dashboard/save_partner_links/<?php if (!empty($task_details->task_contact_id)) {
                                            echo $task_details->task_contact_id;
                                        }?>" method="post" class="form-horizontal">
                                            <div class="col-sm-12 link_box" >
                                                <div class="col-sm-11" style="background:#83c583; border: none; padding-top: 5px;">
                                                ...
                                                <div class="col-sm-11 sum" style="border:1px solid #EFEFEF;; padding-top: 15px;" >
                                                    ...
                                                    <div class="col-sm-1"> <a href ="<?= base_url() ?>employee/dashboard/delete_partner_link/<?= $partner->partner_id ?>/<?= $task_details->task_contact_id?>" class="btn btn-danger btn-xs delete" style="margin:5px">  &nbsp;X </a></div></div>
