    ...
    <div class="col-sm-12">
        <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs">
                <li class="<?= $active == 1 ? 'active' : '' ?>"><a href="#employee_list" data-toggle="tab"><?= lang('deleted_employee_list') ?></a>
                </li>
            </ul>
...
//                                    die();
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo "$v_employee->first_name " . "$v_employee->last_name"."($v_employee->employment_id)"; ?></td>
                                            ...
                                            <td >
                                                ...
                                                <?php echo btn_delete('admin/employee/restore_employee/' . $v_employee->employee_id ); ?>
                                            </td>
                                        </tr>
                                        <?php
                                        else:
