                ...
                <div class="box box-default" data-collapsed="0">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="field-1" class="col-sm-4 control-label"><?= lang('email') ?><span class="required"> *</span></label>
                            <div class="col-sm-7">
                                <input type="text" name="email" value="<?php echo $this->session->userdata('email'); ?>" class="form-control"  placeholder="Enter Your E-mail address" />
                            </div>
                        </div>
                        <div class="form-group">
