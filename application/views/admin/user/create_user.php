                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="field-1" class="col-sm-3 control-label">Flag <span class="required"> *</span></label>

                                <div class="col-sm-8">
                                    <input type="checkbox" name="flag" >
                                    <div class="required" id="flag_result"></div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    ?>" class="form-control" onchange="check_user_name(this.value)" placeholder="User Name" required/>
                            ...
                            <div class="col-sm-offset-3 col-sm-8">
                                <button type="submit" id="sbtn" class="btn btn-primary"><?php echo!empty($user_info) ? 'Update User' : 'Create User' ?></button>
                            </div>
