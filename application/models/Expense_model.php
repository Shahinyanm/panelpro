...
class Expense_Model extends MY_Model {
    ...
    public function get_expense_list_by_date($start_date, $end_date) {
        ...
        $this->db->select('tbl_expense_bill_copy.expense_bill_copy_id,tbl_expense_bill_copy.expense_id as bill_id,tbl_expense_bill_copy.bill_copy,tbl_expense_bill_copy.bill_copy_filename,tbl_expense_bill_copy.bill_copy_path', FALSE);
